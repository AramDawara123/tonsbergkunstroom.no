        ...
        {isLoading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {photos.map((photo) => (
              <div 
                key={photo.id} 
                className="group relative overflow-hidden rounded-2xl shadow-lg nordic-hover-lift"
              >
        ...
        <div className="text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 inline-block shadow-lg">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Oppdag alle unike kunstverk som spenner over ulike medier og nordiske temaer.
            </p>
