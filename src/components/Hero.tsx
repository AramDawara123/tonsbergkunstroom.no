...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center nordic-texture overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center z-10 relative">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="space-y-8">
            <h1 className="nordic-display animate-nordic-fade-up" style={{ animationDelay: '0.2s' }}>
              Where Art Meets
              <span className="block nordic-gradient-text">Nordic Soul</span>
            </h1>
            
            <p className="nordic-subtitle max-w-3xl mx-auto animate-nordic-fade-up leading-loose" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-nordic-fade-up" style={{ animationDelay: '0.6s' }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mt-16 animate-nordic-fade-up" style={{ animationDelay: '0.8s' }}>
      ...
      <div className="absolute bottom-20 right-10 w-60 h-60 bg-gradient-to-br from-nordic-ice/40 to-nordic-mist/30 rounded-full blur-3xl nordic-float" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 right-20 w-32 h-32 bg-gradient-to-br from-primary/20 to-nordic-forest/20 rounded-full blur-3xl nordic-float" style={{ animationDelay: '4s' }} />
    </section>
  );
};
