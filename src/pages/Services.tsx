      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {classes.map((classItem, index) => <div key={index} className="nordic-card group nordic-hover-lift">
                <div className="p-8">
                  ...
                  <Link to={`/course/${classItem.id}`} className="nordic-button-primary w-full inline-flex items-center justify-center gap-2 group/btn">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 mb-8">
                {commissionFeatures.map((feature, index) => <div key={index} className="flex items-start space-x-4">
            ...
            <div className="relative">
              <div className="nordic-card overflow-hidden nordic-hover-lift">
                <img src="https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="Custom artwork process" className="w-full h-96 object-cover" />
              </div>
