    ...
    <div className="min-h-screen">
      ...
      <section className="pt-24 pb-16 bg-nordic-gradient">
        <div className="container mx-auto px-6 text-center">
          <h1 className="nordic-heading mb-4">Our Services</h1>
          <p className="nordic-subtitle max-w-2xl mx-auto">
            Whether you're beginning your artistic journey or seeking a custom masterpiece, 
            we offer personalized experiences that celebrate Nordic creativity.
          </p>
        </div>
      </section>
