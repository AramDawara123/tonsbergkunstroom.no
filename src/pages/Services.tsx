...
import { Palette, Users, Heart, Clock } from 'lucide-react';
const Services = () => {
  const classes = [{
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="nordic-heading mb-4">Art Classes</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {classes.map((classItem, index) => <div key={index} className="nordic-card">
                <div className="p-8">
                  ...
                  <button className="nordic-button-primary w-full">
                    Book Class
                  </button>
                </div>
              </div>)}
